        ...
        <div className="p-4 max-w-md mx-auto border rounded-lg shadow-md">
            {step === 1 && (
                <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <h2 className="text-xl font-bold mt-4">Regístrate</h2>
                    <input
                        type="text"
                        name="email"
                    ...
                    <input
                        ...
                        className="w-50 p-2 mt-3 border rounded"
                    />
                    <button onClick={nextStep} className="mt-4 p-2 btn bg-info text-white">
                        Iniciar sesión
                    </button>
                    <p className="mt-2 btn text-warning" onClick={() => setStep(99)}>¿Has olvidado tu contraseña?</p>
                    <p>¿No tienes una cuenta con nosotros?
                        <Link to="/register" className="btn text-warning m-0">¡Crear una ahora!</Link></p>
                </div>
            )}
